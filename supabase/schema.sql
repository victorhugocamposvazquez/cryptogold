...
-- ============================================================
-- TOKEN ON-CHAIN — registro persistente (admin / service_role)
-- Evita depender de /tmp en Vercel ni de env por cada deploy.
-- ============================================================
...
-- Sin policies públicas: solo service_role (backoffice) vía API routes.
